...
export default function CommandCenterPage() {
  ...
  return (
    <div className="flex h-full min-h-0 min-w-0 flex-col gap-3 overflow-hidden p-3">
      ...
      <div className="grid min-h-0 min-w-0 flex-1 grid-rows-[minmax(0,1fr)] grid-cols-1 gap-3 overflow-hidden xl:grid-cols-[minmax(240px,300px)_minmax(0,1fr)_minmax(260px,320px)]">
        <MissionAreasPanel className="min-h-0 overflow-hidden" onCreate={() => navigate('/missions')} />
        <CommandMap className="h-full min-h-[320px] min-w-0 xl:min-h-0" />

        <div className="flex min-h-0 min-w-0 flex-col gap-3 overflow-y-auto overflow-x-hidden pr-1">
