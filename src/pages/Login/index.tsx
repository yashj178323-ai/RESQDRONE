    ...
    <main className="relative grid min-h-screen grid-cols-1 overflow-hidden bg-canvas lg:grid-cols-[1.1fr_minmax(0,460px)]">
      ...
      <section className="relative hidden flex-col justify-between p-12 lg:flex">
        ...
        <div className="max-w-md">
          ...
          <div className="mt-3 inline-flex items-center gap-2 rounded-control border border-warn/30 bg-warn/10 px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-warn">
            DEMO / SIMULATION MODE · NO SERVER AUTHENTICATION
          </div>
        </div>
      </section>
