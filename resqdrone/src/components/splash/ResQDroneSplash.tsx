...
export function ResQDroneSplash({ onDone }: { onDone: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="resq-scanline pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-transparent via-info/[0.07] to-transparent"
        aria-hidden
      />
      ...
      <div className="relative flex flex-col items-center px-6">
        ...
        <div className="mt-14 text-center">
          <h1 className="text-3xl font-bold tracking-[0.16em] text-ink">RESQDRONE</h1>
          <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-info">
