    ...
    <main className="relative grid min-h-screen grid-cols-1 overflow-hidden bg-canvas lg:grid-cols-[1.1fr_minmax(0,460px)]">
      ...
      <section className="relative hidden flex-col justify-between p-12 lg:flex">
        <div className="flex items-center gap-3">
          <span className="grid h-9 w-9 place-items-center rounded-control bg-info text-white">
            <ShieldAlert size={19} aria-hidden />
          </span>
          <div>
            <p className="text-base font-bold tracking-[0.12em] text-ink">RESQDRONE</p>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-7 space-y-4">
            ...
            <button
              ...
              className="h-11 w-full rounded-control bg-info text-[13px] font-semibold uppercase tracking-[0.1em] text-white transition-colors ease-ui hover:bg-info/90 disabled:cursor-not-allowed disabled:bg-panel3 disabled:text-dim"
            >
