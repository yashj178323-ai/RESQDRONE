...
const ITEMS = [
  { swatch: 'h-0 w-4 border-t-2 border-dashed border-ok', label: 'Flown path' },
  { swatch: 'h-0 w-4 border-t-2 border-dashed border-action', label: 'Team route' },
  { swatch: 'h-2.5 w-4 border border-crit/60 bg-crit/25', label: 'Search area' },
  { swatch: 'h-2.5 w-4 border border-ok/60 bg-ok/25', label: 'Searched' },
  { swatch: 'h-2.5 w-2.5 rounded-full bg-crit', label: 'P1 incident' },
  { swatch: 'h-2.5 w-2.5 rounded-full bg-warn', label: 'AI detected' },
  { swatch: 'h-2.5 w-2.5 rounded-full bg-ai', label: 'Under review' },
  { swatch: 'h-2.5 w-2.5 rounded-full bg-ok', label: 'Confirmed survivor' },
  { swatch: 'h-2.5 w-2.5 rounded-full bg-info', label: 'Base station' },
