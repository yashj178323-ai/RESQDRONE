...
import type { Priority, Verification } from '@/types';
...
export default function DetectionsPage() {
  ...
  const { teams, recommendation } = useRescueState();
  ...
  return (
    <div className="h-full space-y-4 overflow-y-auto p-4">
      ...
      <div className="flex flex-wrap items-end gap-3 border-t border-edge pt-4">
        ...
        <label className="text-2xs text-dim">
          ...
          >
            ...
            <option value="PENDING">AI detected</option>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
        <Panel title="Full detection log" bodyClassName="max-h-[52vh] overflow-auto">
        ...
        <div className="space-y-3 xl:sticky xl:top-0 xl:max-h-[calc(100vh-9rem)] xl:overflow-y-auto">
          ...
          <Panel title="Verification workflow" bodyClassName="p-3 space-y-2">
            <ol className="space-y-1.5 text-2xs text-muted">
              <li className="flex items-center gap-2">
                <Badge tone="warn">1</Badge> AI detected — model output only, never a survivor
              </li>
              <li className="flex items-center gap-2">
                <Badge tone="ai">2</Badge> Under review — operator inspects RGB and thermal evidence
              </li>
              <li className="flex items-center gap-2">
                <Badge tone="ok">3a</Badge> Confirmed — becomes a survivor and opens an incident
              </li>
              <li className="flex items-center gap-2">
                <Badge tone="neutral">3b</Badge> False detection — closed with an operator note
              </li>
            </ol>
          </Panel>
        </div>
